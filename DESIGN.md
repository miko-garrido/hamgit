...
- **Empty state** (`design/app-empty-state.png`): refresh icon button dimmed (opacity 0.4); centered 56px slate-100 circle with folder-plus icon, "No repositories yet" (15px semibold), body copy 13px slate-500 max 380px centered ("Add local folders to track their branch, status, and remote state. Hamgit only reads your repos — nothing runs without you asking."), dark "Add folders" button.
